...
var ROUTES = {
  ...
  getSiswa: { handler: handleGetSiswa, roles: ['siswa', 'admin', 'guru', 'guru_smp', 'panitia_mpls'] },
  updateSiswa: { handler: handleUpdateSiswa, roles: ['siswa', 'admin'] },
  adminRegisterSiswa: { handler: handleAdminRegisterSiswa, roles: ['admin', 'guru', 'guru_smp'] },
  deleteSiswa: { handler: handleDeleteSiswa, roles: ['admin'] },
  deleteAllSiswa: { handler: handleDeleteAllSiswa, roles: ['admin'] },
  getReferralStats: { handler: handleGetReferralStats, roles: ['admin', 'guru', 'guru_smp'] },

  getGelombang: { handler: handleGetGelombang, roles: ['siswa', 'admin', 'guru', 'guru_smp', 'panitia_mpls'] },
  updateGelombang: { handler: handleUpdateGelombang, roles: ['admin'] },
  deleteGelombang: { handler: handleDeleteGelombang, roles: ['admin'] },
  getConfig: { handler: handleGetConfig, roles: ['siswa', 'admin', 'guru', 'guru_smp', 'panitia_mpls'] },
  updateConfig: { handler: handleUpdateConfig, roles: ['admin'] },

  getEvents: { handler: handleGetEvents, roles: ['siswa', 'admin', 'guru', 'guru_smp', 'panitia_mpls'] },
  ...
  getEngagement: { handler: handleGetEngagement, roles: ['siswa', 'admin', 'guru', 'guru_smp', 'panitia_mpls'] },
  toggleLike: { handler: handleToggleLike, roles: ['siswa', 'admin', 'guru', 'guru_smp', 'panitia_mpls'] },
  addKomentar: { handler: handleAddKomentar, roles: ['siswa', 'admin', 'guru', 'guru_smp', 'panitia_mpls'] },
  sendReminder: { handler: handleSendReminder, roles: ['siswa', 'admin', 'guru', 'guru_smp', 'panitia_mpls'] },

  getTimeline: { handler: handleGetTimeline, roles: ['siswa', 'admin', 'guru', 'guru_smp', 'panitia_mpls'] },
  ...
  getGuruList: { handler: handleGetGuruList, roles: ['admin'] },
  deleteGuru: { handler: handleDeleteGuru, roles: ['admin'] },
  getReferralOptions: { handler: handleGetReferralOptions, roles: ['siswa', 'admin', 'guru', 'guru_smp', 'panitia_mpls'] },
